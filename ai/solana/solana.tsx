...
import { AlertCircle, ArrowRightLeft, CheckCircle2, Copy, ExternalLink } from "lucide-react"
import { z } from "zod"
...
import { transformToPortfolio } from "@/app/types/helius/portfolio"
import { SOL_MINT } from "@/app/types/helius/portfolio"
import { publicKeySchema } from "@/app/types/util"
import { formatShortNumber } from "@/lib/ai/format-utils"
...
const swap = {
  swapTokens: {
    ...
    description: "Swap tokens using Jupiter Exchange with the embedded wallet. (requiresConfirmation)",
    parameters: z.object({
