...
export class SolanaAgentKit {
  ...
  async create3LandCollection(collectionOpts: CreateCollectionOptions, isDevnet = false): Promise<string> {
  ...
  async create3LandNft(
    ...
    const tx = await createSingle(optionsWithBase58, collectionAccount, createItemOptions, !isDevnet, withPool)
    return `Transaction: ${tx}`
  }
