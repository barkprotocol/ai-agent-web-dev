/**
 * Represents the response structure from an API call that returns fungible tokens.
 */
...
/**
 * Represents a fungible token with its associated metadata and properties.
 */
...
/**
 * Represents the content associated with a fungible token.
 */
...
/**
 * Represents various extension configurations for a token mint.
 */
...
/**
 * Represents token-specific information.
 */
...
/**
 * Represents price information for a token.
 */
