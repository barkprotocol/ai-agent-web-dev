      ...
      <div className="flex items-center gap-3">
        <div className="relative h-10 w-10 shrink-0 overflow-hidden rounded-xl">
          <Image
            src={
              token.logoURI ||
              Placeholder.generate({ width: 40, height: 40, text: 'Token'  || "/placeholder.svg"})
            }
            alt={token.name}
...
export const jupiterTools = {
  searchToken: {
    ...
    isCollapsible: true,
    description:
      'Search for any SPL token by name or symbol to get its contract address (mint), along with detailed information like volume and logo. Useful for getting token addresses for further operations.',
    parameters: z.object({
