...
export const TweetHeader = ({ tweet }: { tweet: EnrichedTweet }) => (
  <div className="flex flex-row justify-between tracking-tight">
    <div className="flex items-center space-x-2">
      <a href={tweet.user.url} target="_blank" rel="noreferrer">
        <img
          ...
          height={48}
          width={48}
          src={tweet.user.profile_image_url_https || "/placeholder.svg"}
    ...
    <a href={tweet.url} target="_blank" rel="noreferrer">
      ...
      <RiTwitterXFill className="size-5 items-start transition-all ease-in-out hover:scale-105" />
    </a>
  </div>
)
  ...
  <div className="flex flex-1 items-center justify-center">
    ...
    {!tweet.video &&
      ...
      tweet?.card?.binding_values?.thumbnail_image_large?.image_value.url && (
        <img
          // @ts-ignore
          src={tweet.card.binding_values.thumbnail_image_large.image_value.url || "/placeholder.svg"}
