...
const TokenCardSkeleton = memo(function TokenCardSkeleton() {
  return (
    <div className="group relative animate-pulse overflow-hidden rounded-xl bg-muted/40 p-4" aria-hidden="true">
...
const TokenCard = memo(function TokenCard({ token, className }: TokenCardProps) {
