  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        title: ["var(--font-syne)", "Syne", ...fontFamily.sans],
        body: ["var(--font-poppins)", "Poppins", ...fontFamily.sans],
        syne: ["var(--font-syne)", "Syne", ...fontFamily.sans],
        poppins: ["var(--font-poppins)", "Poppins", ...fontFamily.sans],
        oswald: ["var(--font-oswald)", "Oswald", ...fontFamily.sans],
      },
      backgroundImage: {
